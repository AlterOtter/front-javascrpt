...
1. 자바 스크립트 객체는 object 타입과 function 타입 두가지가 있다.
...
// XmlHttpRequest 호스트(Browser) 객체를 사용해서 통신(AJAX)에서 데이터 교환의 포맷으로 JSON을 사용한다.
var res = '{name:"둘리",age:10,email:"dooly@gmail.com"}';
var UserVo = eval('('+res+')');
